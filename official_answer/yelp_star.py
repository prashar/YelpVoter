...
from lasso import *
from yelp import *
# B = io.mmread("data/star_data.mtx").tocsc()
# z = loadtxt("data/star_labels.txt")

UX = io.mmread("data/star_data.mtx").tocsc()
Ut = loadtxt("data/star_labels.txt", dtype=np.float)
Ul = open("data/star_features.txt").read().splitlines()

Atr = UX[:30000, :].copy()
btr = Ut[:30000].copy()

Av = UX[30000:37000, :].copy()
bv = Ut[30000:37000].copy()
